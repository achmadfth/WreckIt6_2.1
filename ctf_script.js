document.addEventListener('DOMContentLoaded', () => {
    ...
    // Karakter hexadecimal, hanya satu karakter per drop
    ...
    function drawMatrixEffect() {
        ...
        ctxMatrix.fillStyle = '#FFC100';  // Warna teks
        ctxMatrix.font = `${fontSize}px monospace`;

        for (let i = 0; i < drops.length; i++) {
            // Menghasilkan satu karakter hexadecimal acak, tanpa "0x"
    ...
    setInterval(drawMatrixEffect, 33); // Animasi efek matriks
